...
public class QueueReceiver {
	public static void main(String[] args) throws Exception {
		...
		// lookup destination
		javax.jms.Destination destination = (javax.jms.Destination) ctx.lookup("dynamicQueues/thanthidet");
		// tạo connection
		Connection con = (Connection) factory.createConnection("admin", "admin");
		// nối đến MOM
		((javax.jms.Connection) con).start();
		// tạo session
		Session session = ((javax.jms.Connection) con).createSession(/* transaction */false,
